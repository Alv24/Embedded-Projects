# Embedded-Projects 
#Aerodynamic Motion Classification using STM32
...
void Log()
{
	 ...
	 for(int i=0; i<DATA_INPUT_USER; i++)
	 {
		 printf("Ax =%.2f",mpu_buffer[AXIS_NUMBER *i]);
		 printf("\r\n");
		 printf("Ay = %.2f",mpu_buffer[AXIS_NUMBER *i + 1]);
		 printf("\r\n ");
		 printf("Az = %.2f",mpu_buffer[AXIS_NUMBER *i + 2]);
		 printf("\r\n ");
	 }
	 printf("\r\n");
	 HAL_Delay(100);
